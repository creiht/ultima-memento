...
Ultima Memento features an extensive crafting system with over 20 professions, multiple harvesting skills, bulk order support, and a global shop system. Each profession uses a specific skill and requires appropriate tools and resources.

## Crafting Professions

| Profession | Skill | Primary Resource | Page |
|---|---|---|---|
| Alchemy | Alchemy | Reagents, Bottles | [alchemy.md](alchemy.md) |
| Apothecary | Alchemy (70+ required) | Rare Reagents, Bottles | [apothecary.md](apothecary.md) |
| Blacksmithy | Blacksmithing | Metal Ingots | [blacksmithy.md](blacksmithy.md) |
| Bonecrafting | Forensics | Skeletal Resources | [bonecrafting.md](bonecrafting.md) |
| Bow Fletching | Bowcraft | Wood (Boards), Feathers | [bowfletching.md](bowfletching.md) |
| Carpentry | Carpentry | Wood (Boards) | [carpentry.md](carpentry.md) |
| Cartography | Cartography | Bark Fragments, Blank Scrolls | [cartography.md](cartography.md) |
| Cooking | Cooking | Various Food Items | [cooking.md](cooking.md) |
| Draconic (Scaled Armor) | Blacksmithing (46+) | Reptile Scales | [draconic.md](draconic.md) |
| Druidism (Herbalism) | Druidism | Reagents, Jars | [druidism-crafting.md](druidism-crafting.md) |
| Glassblowing | Alchemy (100+ required) | Sand | [glassblowing.md](glassblowing.md) |
| Inscription | Inscription | Reagents, Blank Scrolls, Leather | [inscription.md](inscription.md) |
| Lapidary | Blacksmithing (65+) | Gemstone Blocks | [lapidary.md](lapidary.md) |
| Leatherworking | Tailoring | Leather | [leatherworking.md](leatherworking.md) |
| Masonry | Carpentry (100+ required) | Granite | [masonry.md](masonry.md) |
| Shelves | Carpentry | Wood (Boards) | [shelves.md](shelves.md) |
| Stitching | Tailoring (65+) | Demon Skins | [stitching.md](stitching.md) |
| Tailoring | Tailoring | Fabric | [tailoring.md](tailoring.md) |
| Tinkering | Tinkering | Metal Ingots, Wood | [tinkering.md](tinkering.md) |
| Wands | Inscription | Metal Ingots, Spell Scrolls, Arcane Gems | [wands.md](wands.md) |
| Wax Crafting | Cooking | Beeswax | [wax-crafting.md](wax-crafting.md) |
| Witchery | Forensics | Witch Reagents, Jars | [witchery.md](witchery.md) |

## Harvesting Skills

| Skill | Description | Page |
|---|---|---|
| Mining | Harvest ore, granite, sand, and gems | [mining.md](mining.md) |
| Lumberjacking | Harvest logs and bark from trees | [lumberjacking.md](lumberjacking.md) |
| Fishing (Seafaring) | Catch fish and special items from water | [fishing.md](fishing.md) |
| Grave Robbing | Dig bones, reagents, and relics from graves | [grave-robbing.md](grave-robbing.md) |
...
Many crafting systems support:
- **Repair** - Fix damaged equipment using the appropriate tool
- **Breakdown** - Salvage materials from items you no longer need
- **Enhancement** - Improve items with special materials
