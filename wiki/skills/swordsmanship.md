...
Swordsmanship is the default weapon skill for most bladed melee weapons. It also powers the Jedi and Syth magic systems, serving as the damage scaling skill for their spells. Unlike many other skills, it has no anti-macro restrictions and can be trained anywhere by swinging weapons.
...
### Training & Behavior
- `SkillCheck.cs:56` — Swordsmanship is skill index 40 in the anti-macro gain array. Anti-macro is **disabled** (`false`) — can be trained anywhere by swinging weapons.
- `SkillCheck.cs:256` — Warriors Guild affiliation grants skill gain on Swordsmanship.
...
- [Psychology](psychology.md): Third prerequisite for Jedi/Syth casting (requires 10 in all three)
...
- [Jedi](../magic/jedi.md): Magic system that uses Swordsmanship as damage skill
- [Syth](../magic/syth.md): Magic system that uses Swordsmanship as damage skill
- [Weapon Abilities](../systems/weapon-abilities.md): Swordsmanship contributes to mana cost reduction

## Notes
- Anti-macro is disabled for Swordsmanship — it can be trained anywhere by swinging weapons.
- When a weapon has `UseBestSkill > 0`, the game picks whichever weapon skill (Swordsmanship, Fencing, Bludgeoning, FistFighting) is highest.
- Syth alignment detection uses 50+ Swordsmanship, 50+ Psychology, and karma <= -5000 as criteria.
- During character creation, choosing Swordsmanship grants a random starting weapon (Bokuto, Cleaver, or Cutlass).
