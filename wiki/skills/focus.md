...
| **Skill Check** | N/A (passive gain only) |

## Description

Focus passively boosts stamina and mana regeneration rates. Unlike Meditation, its mana bonus is not blocked by armor. It also serves as a prerequisite for the Mystic (Monk) magic specialization.
...
Focus is also used as both cast and damage skill by the minor `MagicalSpell` class, which some magic items invoke (e.g., attack spells, identification, teleportation, lightning attacks, and summoning).

## How to Train

Focus gains passively — each stamina and mana regen tick calls `CheckBonusSkill` automatically. Simply existing and regenerating resources will raise Focus over time. Wearing armor does not interrupt this gain.
...
### Synergies
- [Meditation](meditation.md): The other co-requisite for Monk status; provides larger active mana regen (blocked by armor).
- [Elementalism](elementalism.md): Co-taught by Elemental Guild; Focus is one of its allowed training skills.

### Prerequisites / Co-requisites
- [Mystic (Monk) magic](../magic/mystic.md): Requires 100 base Focus, 100 base Meditation, 100 base Fist Fighting, and a MysticMonkRobe.
- [Fist Fighting](fist-fighting.md): Primary Monk combat skill; co-requisite for Mystic spellcasting.

### Synergies
- [Elixirs](../items/potions.md): Elixir of Focus provides temporary +10 to +60 Focus boost.
- [Avatar Shop](../systems/avatar.md): Focus and Meditation auto-locked when selecting a template.
- [Codex of Knowledge](../quests/codex.md): Learning option 21 grants Focus skill.
- [Henchmen](../systems/henchmen.md): All henchman types pre-set with Focus at their base skill level.

## Notes

- Focus is one of the few skills that trains passively without any player action beyond existing and regenerating.
- Its mana regen bonus is unique in that it works even while wearing heavy armor, unlike Meditation.
- The "Driven" title is automatically assigned to characters with Focus skill via the Learn Titles book.
