...
Use the Anatomy skill and target a living creature. On success, you receive a descriptive message about the target's **strength** and **dexterity** (e.g. "That looks very strong and extremely agile"). At **65.0+ skill**, you also learn their current **stamina percentage**.
