...
| **Skill Type** | Detection / Utility |
| **Skill Check** | 0 - 125 (corpses), 40 - 125 (mobiles) |

## Description

Forensics is a detection skill used to investigate crime scenes, identify Thieves' Guild members, and examine various objects for evidence. Beyond investigation, it synergizes with harvesting, crafting, and corpse skinning systems.
...
Examine corpses, locked containers, and NPCs. Corpse examination has a skill check from 0-125, making it the easiest way to gain. Additionally, corpse skinning performs a Forensics skill check (0-100) whenever you carve resources, contributing to training.
...
- [Grave Robbing](../crafting/grave-robbing.md): Uses Forensics as its primary skill definition.
- [Witchery](../crafting/witchery.md): Requires Forensics as primary crafting skill.

## Notes
- Forensics is an auto-trainable skill — it gains automatically during certain activities like skinning corpses.
- The Polish Bone Brush is the only tool that converts regular bones into rare skeletal types, making it valuable for crafting.
- Players with high Forensics and negative karma gain the "Undertaker" classification, which has gameplay implications.
- Grave Robbing becomes significantly more dangerous at higher Forensics levels due to increased "grave raiser" encounter rates.
